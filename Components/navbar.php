...
<head>
  ...
  <title>frexi tour management</title>
  ...
  <link rel="icon" type="image/png" sizes="192x192" href="assets/img/frexilogo.png">
   <!-- Favicon link -->
   <link rel="icon" href="assets/img/frexilogo.png" type="image/x-icon" />

<!-- Optional: Provide additional favicon sizes -->
<link rel="icon" href="assets/img/frexilogo.png" sizes="32x32" type="image/png">
<link rel="icon" href="assets/img/frexilogo.png" sizes="16x16" type="image/png">
