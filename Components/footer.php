        ...
        <div class="widget-area">
            <div class="container">
             ...
             <h1 style="font-size: 35px; text-transform:capitalize;font-size:20px;margin-top:32px;font-style:italic">frexi tours and travel</h1>
                                ...
                                <div class="th-social"><a href="https://www.facebook.com/frexiltd" target="_blank"><i class="fab fa-facebook-f"></i></a> <a href="https://www.twitter.com/frexiltd" target="_blank"><i class="fab fa-x"></i></a> <a href="https://www.linkedin.com/in/fabrice-iradukunda-77b309127" target="_blank"><i class="fab fa-linkedin-in"></i></a> <a href="https://www.whatsapp.com/+250782379122"><i class="fab fa-whatsapp"></i></a> <a href="https://instagram.com/frexiltd" target="_blank"><i class="fab fa-instagram"></i></a></div>
                            </div>
                        </div>
                    </div>
