!(function(e) {
    ...
    return (function e(t, n, o) {
        ...
        for (
            var r = "function" == typeof require && require, s = 0; s < o.length; s++
        )
            i(o[s]);
        return i;
    })({
            ...
            function(e, t, n) {
                ...
                !(function() {
                    ...
                    (o.scale = function(e, n, r, s) {
                        ...
                        if (
                            (e.circleRadius &&
                                (n === r ? (e.circleRadius *= n) : (e.circleRadius = null)), !e.isStatic)
                        ) {
                            var u = t(e);
                            (e.area = u.area),
                            o.setMass(e, u.mass),
        ...
        2: [
            function(e, t, n) {
                ...
                (o.allBodies = function(e) {
                    for (
                        var t = [].concat(e.bodies), n = 0; n < e.composites.length; n++
                    )
                ...
                (o.allConstraints = function(e) {
                    for (
                        var t = [].concat(e.constraints), n = 0; n < e.composites.length; n++
                    )
                ...
                (o.allComposites = function(e) {
                    for (
                        var t = [].concat(e.composites), n = 0; n < e.composites.length; n++
                    )
                ...
                (o.translate = function(e, t, n) {
                    for (
                        var i = n ? o.allBodies(e) : e.bodies, r = 0; r < i.length; r++
                    )
                        s.translate(i[r], t);
                    return o.setModified(e, !0, !0, !1), e;
                }),
                ...
                (o.scale = function(e, t, n, i, r) {
                    for (
                        var a = r ? o.allBodies(e) : e.bodies, l = 0; l < a.length; l++
                    ) {
                        var c = a[l],
                            d = c.position.x - i.x,
                            u = c.position.y - i.y;
                ...
                (o.collisions = function(e, t) {
                    for (var n = [], a = t.pairs.table, l = 0; l < e.length; l++) {
                        ...
                        if (
                            ...
                            for (
                                var u = c.parts.length > 1 ? 1 : 0; u < c.parts.length; u++
                            )
                                for (
                                    var p = c.parts[u], m = d.parts.length > 1 ? 1 : 0; m < d.parts.length; m++
                                ) {
                                    var f = d.parts[m];
                                    if (
                                        (p === c && f === d) ||
            ...
            function(e, t, n) {
                ...
                (o.update = function(e, t, n) {
                    var o,
                        ...
                        f = [];
                    for (
                        u.length = 0, p.length = 0, m.length = 0, l = 0; l < t.length; l++
                    )
                        (o = t[l]).collided &&
                ...
                (o.ray = function(e, t, n, o) {
                    ...
                    for (
                        ...
                        if (s.overlaps(v.bounds, p.bounds))
                            for (
                                var y = 1 === v.parts.length ? 0 : 1; y < v.parts.length; y++
                            ) {
                                var g = v.parts[y];
                ...
                (o.point = function(e, t) {
                    for (var n = [], o = 0; o < e.length; o++) {
                        ...
                        if (s.contains(i.bounds, t))
                            for (
                                var r = 1 === i.parts.length ? 0 : 1; r < i.parts.length; r++
                            ) {
                                var a = i.parts[r];
            ...
            function(e, t, n) {
                ...
                !(function() {
                    ...
                    var e = function(e, n, o) {
                        ...
                        t = function(e, t, n) {
                            for (
                                var o = r.dot(t[0], n), i = o, s = 1; s < t.length; s += 1
                            ) {
                                var a = r.dot(t[s], n);
                                a > i ? (i = a) : a < o && (o = a);
                            }
            ...
            function(e, t, n) {
                ...
                !(function() {
                    ...
                    (o.create = function(t) {
                        ...
                        return (
                            (n.render = c.extend({ visible: !0, lineWidth: 2, strokeStyle: "#ffffff" },
                                n.render
                            )),
                            (n.id = n.id || c.nextId()),
                            ...
                            if (o.bodyB) r.set(o.bodyB, !1), (o.pointA = n.position);
                                ...
                                for (var c = 0; c < t.length; c++)
                                    if (
                                        ...
                                        for (
                                            var d = s.parts.length > 1 ? 1 : 0; d < s.parts.length; d++
                                        ) {
                                            var u = s.parts[d];
            ...
            function(e, t, n) {
                ...
                !(function() {
                    ...
                    (o.update = function(o, i, a) {
                        ...
                        for (
                            s.postSolvePosition(x), s.preSolveVelocity(w.list), c = 0; c < o.velocityIterations; c++
                        )
            ...
            function(e, t, n) {
                (function(n) {
                    ...
                    (o.polygon = function(e, t, n, a, l) {
                        ...
                        for (
                            var c = (2 * Math.PI) / n, d = "", u = 0.5 * c, p = 0; p < n; p += 1
                        ) {
                            var m = u + p * c,
                                f = Math.cos(m) * a,
                                v = Math.sin(m) * a;
        ...
        24: [
            function(e, t, n) {
                ...
                (o.newtonsCradle = function(e, t, n, o, s) {
                    for (
                        var a = i.create({ label: "Newtons Cradle" }), c = 0; c < n; c++
                    ) {
        ...
        25: [
            function(e, t, n) {
                ...
                (o.rotate = function(e, t) {
                    if (0 !== t)
                        for (
                            var n = Math.cos(t), o = Math.sin(t), i = 0; i < e.length; i++
                        ) {
                            var r,
                                s = e[i];
                ...
                e("../geometry/Bounds"),
                    (function() {
                        o.pathToVertices = function(t, n) {
                            ...
                            for (
                                e(t), r = t.getTotalLength(), l = [], o = 0; o < t.pathSegList.numberOfItems; o += 1
                            )
        ...
        29: [
            function(e, t, n) {
                ...
                (o.centre = function(e) {
                    for (
                        var t, n, r, s = o.area(e, !0), a = { x: 0, y: 0 }, l = 0; l < e.length; l++
                    )
                        (r = (l + 1) % e.length),
                        (t = i.cross(e[l], e[r])),
                ...
                (o.rotate = function(e, t, n) {
                    if (0 !== t) {
                        for (
                            var o = Math.cos(t), i = Math.sin(t), r = 0; r < e.length; r++
                        ) {
                            var s = e[r],
                                a = s.x - n.x,
                                l = s.y - n.y;
                    ...
                    "undefined" != typeof window &&
                        ...
                        (o.bodies = function(e, t, n) {
                            ...
                            for (r = 0; r < t.length; r++)
                                if ((o = t[r]).render.visible)
                                    for (
                                        s = o.parts.length > 1 ? 1 : 0; s < o.parts.length; s++
                                    )
                        ...
                        (o.bodyWireframes = function(e, t, n) {
                            ...
                            for (l.beginPath(), r = 0; r < t.length; r++)
                                if ((o = t[r]).render.visible)
                                    for (
                                        a = o.parts.length > 1 ? 1 : 0; a < o.parts.length; a++
                                    ) {
                                        for (
                                            i = o.parts[a],
                        ...
                        (o.bodyConvexHulls = function(e, t, n) {
                            ...
                            for (s.beginPath(), i = 0; i < t.length; i++)
                                if ((o = t[i]).render.visible && 1 !== o.parts.length) {
                                    for (
                                        s.moveTo(o.vertices[0].x, o.vertices[0].y), r = 1; r < o.vertices.length; r++
                                    )
                        ...
                        (o.bodyBounds = function(e, t, n) {
                            ...
                            for (var r = 0; r < t.length; r++) {
                                if (t[r].render.visible)
                                    for (
                                        var s = t[r].parts, a = s.length > 1 ? 1 : 0; a < s.length; a++
                                    ) {
                                        var l = s[a];
                                        o.rect(
                                            l.bounds.min.x,
                        ...
                        (o.collisions = function(e, t, n) {
                            ...
                            for (a.beginPath(), r = 0; r < t.length; r++)
                                if ((o = t[r]).isActive)
                                    for (
                                        i = o.collision, s = 0; s < o.activeContacts.length; s++
                                    ) {
            ...
            function(e, t, n) {
                ...
                !(function() {
                    ...
                    "undefined" != typeof window &&
                        ...
                        (o.clear = function(e) {
                            for (
                                var t = e.container, n = e.spriteContainer; t.children[0];
                            ...
                            if (o.visible)
                                if (o.sprite && o.sprite.texture) {
                                    var i = "b-" + t.id,
                                        r = e.sprites[i],
                                        a = e.spriteContainer;
                                    r || (r = e.sprites[i] = n(e, t)), -1 === s.indexOf(a.children, r) && a.addChild(r),
                                    ...
                                    var l = "b-" + t.id,
                                        ...
                                        u = e.container;
                                    d ||
                                        ((d = e.primitives[l] = c(e, t)).initialAngle = t.angle), -1 === s.indexOf(u.children, d) && u.addChild(d),
                    ...
                    var n = function(e, t) {
                        ...
                        c = function(e, t) {
                            ...
                            r.clear();
                            for (
                                var p = t.parts.length > 1 ? 1 : 0; p < t.parts.length; p++
                            ) {
                                (n = t.parts[p]),
                                i.wireframes ?
