!(function(e) {
    ...
    (e.widget = function(t, i, s) {
        ...
        return (
            ...
            (a.prototype = e.widget.extend(
                o, { widgetEventPrefix: (n && o.widgetEventPrefix) || t },
                h, { constructor: a, namespace: l, widgetName: t, widgetFullName: u }
            )),
            n ?
    ...
    (e.Widget.prototype = {
        ...
        option: function(t, i) {
            ...
            if ("string" == typeof t)
                if (((o = {}), (t = (s = t.split(".")).shift()), s.length)) {
                    for (
                        n = o[t] = e.widget.extend({}, this.options[t]), a = 0; a < s.length - 1; a++
                    )
                        (n[s[a]] = n[s[a]] || {}), (n = n[s[a]]);
        ...
        _classes: function(t) {
            ...
            return (
                (t = e.extend({ element: this.element, classes: this.options.classes || {} },
                    t
                )),
        ...
        e.widget("ui.slider", e.ui.mouse, {
            ...
            _mouseDrag: function(e) {
                ...
                return (
                    ...
                    this._slide(e, this._handleIndex, t), !1
                );
            },
            ...
            _setOption: function(t, i) {
                ...
                switch (
                    ...
                    case "values":
                        for (
                            this._animateOff = !0, this._refreshValue(), s = n - 1; 0 <= s; s--
                        )
                            this._change(null, s);
                        this._animateOff = !1;
                        break;
                ...
                this._hasMultipleValues() ?
                    this.handles.each(function(s) {
                        ...
                        (r["horizontal" === l.orientation ? "left" : "bottom"] =
                            i + "%"),
                        e(this).stop(1, 1)[u ? "animate" : "css"](r, h.animate), !0 === l.options.range &&
                            ("horizontal" === l.orientation ?
                                (0 === s &&
                                    l.range
                                    .stop(1, 1)[u ? "animate" : "css"]({ left: i + "%" }, h.animate),
                                    1 === s &&
                                    l.range[u ? "animate" : "css"]({ width: i - t + "%" }, { queue: !1, duration: h.animate })) :
                                (0 === s &&
                                    l.range
                                    .stop(1, 1)[u ? "animate" : "css"]({ bottom: i + "%" },
                                        h.animate
                                    ),
                                    1 === s &&
                                    l.range[u ? "animate" : "css"]({ height: i - t + "%" }, { queue: !1, duration: h.animate }))),
                            (t = i);
                    }) :
                    ((s = this.value()),
                        (n = this._valueMin()),
                        ...
                        "horizontal" === this.orientation &&
                        this.range
                        .stop(1, 1)[u ? "animate" : "css"]({ width: i + "%" }, h.animate),
                        "max" === o &&
                        "horizontal" === this.orientation &&
                        this.range
                        .stop(1, 1)[u ? "animate" : "css"]({ width: 100 - i + "%" }, h.animate),
                        "min" === o &&
                        "vertical" === this.orientation &&
                        this.range
                        .stop(1, 1)[u ? "animate" : "css"]({ height: i + "%" }, h.animate),
                        "max" === o &&
                        "vertical" === this.orientation &&
                        this.range
                        .stop(1, 1)[u ? "animate" : "css"]({ height: 100 - i + "%" }, h.animate));
            },
            _handleEvents: {
                keydown: function(t) {
                    var i,
