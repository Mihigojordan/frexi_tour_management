var Swiper = (function() {
    ...
    function O(e) {
        ...
        if (
            (r.touchReleaseOnEdges && (T = 0),
                ...
                S && (c.preventedByNestedSwiper = !0), !s.allowSlideNext &&
    ...
    function D(e) {
        ...
        if (
            (a >= 0 && s.evCache.splice(a, 1), ["pointercancel", "pointerout", "pointerleave", "contextmenu"].includes(
                    e.type
                ) &&
    ...
    const re = [
        function(e) {
            ...
            function c(e) {
                const {
                    ...
                    centeredSlides: i,
                    loop: r,
                } = s.params, { addSlidesBefore: l, addSlidesAfter: o } = s.params.virtual, { from: c, to: p, slides: u, slidesGrid: m, offset: f } = s.virtual;
                    ...
                    g = (function(e) {
                        ...
                        return (
                            ...
                            (1 === e.deltaMode ?
                                ...
                                ((a *= 800), (i *= 800))),
                            a && !t && (t = a < 1 ? -1 : 1),
                            i && !s && (s = i < 1 ? -1 : 1), { spinX: t, spinY: s, pixelX: a, pixelY: i }
                        );
                    })(s);
                if (r.forceToAxis)
                    if (t.isHorizontal()) {
            ...
            function p() {
                ...
                if (
                    ((t.params.navigation = W(
                        ...
                        t.params.navigation, { nextEl: "swiper-button-next", prevEl: "swiper-button-prev" }
                    )), !e.nextEl && !e.prevEl)
                )
                    return;
                let s = n(e.nextEl),
        ...
        function(e) {
            ...
            function h() {
                t.params.pagination = W(
                    ...
                    t.params.pagination, { el: "swiper-pagination" }
                );
                const e = t.params.pagination;
                if (!e.el) return;
                let s;
        ...
        function(e) {
            ...
            function v() {
                ...
                const { scrollbar: e, rtlTranslate: s } = t, { dragEl: a, el: i } = e,
            ...
            function M() {
                ...
                t.params.scrollbar = W(
                    ...
                    t.params.scrollbar, { el: "swiper-scrollbar" }
                );
        ...
        function(e) {
            ...
            function P(e) {
                ...
                1 === c && z && ((i = void 0), (r = void 0)),
                    ...
                    (c =
                        z || m.imageWrapEl.getAttribute("data-swiper-zoom") || a.maxRatio), !e || (1 === c && z) ?
                    ((u = 0), (v = 0)) :
        ...
        function(e) {
            let t,
                s, { swiper: i, extendParams: r, on: n, emit: l, params: o } = e;
        ...
        function(e) {
            let t,
                s,
                a,
                i, { swiper: r, extendParams: n, on: l } = e;
                ...
                (r.grid = {
                    ...
                    updateSlide: (e, i, n, l) => {
                        const { slidesPerGroup: d } = r.params,
                            c = o(), { rows: p, fill: u } = r.params.grid;
                        let m, h, f;
                        if ("row" === u && d > 1) {
