...
!(function(t, e) {
            ...
            function(t, i, n) {
                ...
                if (!b) {
                    if (!(x = "auto" === e.grid ? 0 : (e.grid || [1, Gt])[1])) {
                        for (
                            v = -Gt; v < (v = n[x++].getBoundingClientRect().left) && x < w;
                    ...
                    if (
                        ...
                        if (
                            ((i = T(v % o)),
                                ...
                                ((a = ~~(v / o)) && a === v / o && ((i = g), a--),
                                    g < i && (i = g)),
                                (c = be(this._tTime, o)), !d && this._tTime && c !== a && (c = a),
                                p && 1 & a && ((i = g - i), (_ = 1)),
                                a !== c && !this._lock)
                        ) {
                            var x = p && 1 & c,
                            ...
                            if (
                                (a < c && (x = !x),
                                    ...
                                    (this._tTime = v), !e && this.parent && Se(this, "onRepeat"),
                    ...
                    if (
                        (this._hasPause &&
                            ...
                            ((this._onUpdate = this.vars.onUpdate),
                                (this._initted = 1),
                                (this._zTime = t),
                                (d = 0)), !d && i && !e && (Se(this, "onStart"), this._tTime !== v))
                    )
                        return this;
                    if (d <= i && 0 <= t)
                        for (n = this._first; n;) {
    ...
    function Ze(t, e, r, s, a, u) {
        ...
        if (
            ...
            (h = new ge[t]()).init(
                ...
                (function(t, e, r, s, a) {
                    if (
                        (n(t) && (t = rr(t, a, e, r, s)), !o(t) || (t.style && t.nodeType) || re(t) || ee(t))
                    )
            ...
            if (
                (i(s) &&
                    (~s.indexOf("random(") && (s = nt(s)),
                        "=" === s.charAt(1) &&
                        ((!(p = w(d, s) + (H(d) || 0)) && 0 !== p) || (s = p))), !l || d !== s || Ke)
            )
                return isNaN(d * s) || "" === s ?
                    (_ || e in t || c(e, s),
        ...
        er = function t(e, r, i) {
            ...
            if (
                (!N || (R && T) || (T = "none"),
                    ...
                    (e._from = !N && !!x.runBackwards), !N || (R && !x.stagger))
            ) {
                if (
                ...
                for (
                    e._pt = e._ptCache = 0, O = (B && u(O)) || (O && !B), s = 0; s < I.length; s++
                ) {
                    if (
    ...
    var sr = (function(t) {
        function n(e, i, n, a) {
            ...
            if (
                ...
                if (
                    ...
                    for (c = 0; c < d; c++)
                        ...
                        (_.delay = (+rr(M, r(h), c, v, B) || 0) - h._delay), !k &&
                        1 === d &&
                        _.delay &&
            ...
            return (!0 !== A || gt || ((Je = r(h)), xt.killTweensOf(B), (Je = 0)),
                N(F, r(h), n),
                ...
                if (_) {
                    if (
                        ...
                        if (((i = m), (f = this.timeline), this._repeat)) {
                            ...
                            s !== o &&
                                (f && this._yEase && ct(f, u), !this.vars.repeatRefresh ||
                                    u ||
                                    this._lock ||
                                    ((this._lock = r = 1),
                        ...
                        this._onUpdate &&
                            ...
                            (d && !this._onUpdate && B(this, t, 0, !0),
                                ...
                                (d && !c) ||
                                !(m || c || u) ||
                                (Se(this, m === p ? "onComplete" : "onReverseComplete", !0), !this._prom ||
            ...
            (a.resetTo = function(t, e, r, i) {
                ...
                return (
                    ...
                    (function(t, e, r, i, n, s, a) {
                        ...
                        if (!l)
                            for (
                                l = t._ptCache[e] = [], h = t._ptLookup, f = t._targets.length; f--;
    ...
    function $r() {
        ...
        if (this.tfm) {
            ...
            s.svg &&
                (s.renderTransform(),
                    i.setAttribute("data-svg-origin", this.svgo || "")), !(t = ki()) || t.isStart || n[tn] || (Zr(n), (s.uncache = 1));
        }
    }
    ...
    function ni(t) {
        ...
        return (
            (e && (e.width || e.height)) || t.getBBox === ri || (e = ri.call(t, !0)), !e || e.width || e.x || e.y ?
            e :
            {
                x: +ii(t, ["x", "cx", "x1"]) || 0,
                y: +ii(t, ["y", "cy", "y1"]) || 0,
        ...
        return i === h || !u || sn[i] || sn[h] ?
            ...
            ("px" === h || _ || (u = ui(t, e, r, "px")),
                ...
                ((f[l ? "width" : "height"] = 100 + (_ ? h : i)),
                    (s = ~e.indexOf("adius") || ("em" === i && t.appendChild && !c) ?
                        t :
                        t.parentNode),
    ...
    var xi,
        ...
        nn = function(t, e, r) {
            ...
            for (
                t = t.charAt(0).toUpperCase() + t.substr(1); n-- && !(rn[n] + t in i);
